  ...
  public:
    DoubleTapSensor(int32_t sensorHandle, ISensorsEventCallback* callback)
        : SysfsPollingOneShotSensor(
                  ...
                  access("/sys/devices/platform/goodix_ts.0/double_tap_enable", F_OK) == 0
  ...
  public:
    SingleTapSensor(int32_t sensorHandle, ISensorsEventCallback* callback)
        : SysfsPollingOneShotSensor(
                  ...
                  access("/sys/devices/platform/goodix_ts.0/aod_enable", F_OK) == 0
                          ? "/sys/devices/platform/goodix_ts.0/aod_enable"
  ...
  public:
    UdfpsSensor(int32_t sensorHandle, ISensorsEventCallback* callback)
        : SysfsPollingOneShotSensor(
                  ...
                  access("/sys/devices/platform/goodix_ts.0/fod_enable", F_OK) == 0
