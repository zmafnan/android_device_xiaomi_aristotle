...
#
# Vendor Logtag configuration for MTK MT6895 (Dimensity 8200 Ultra)
# Suppresses noisy vendor logging on non-eng builds (userdebug/user).
#
...
PRODUCT_VENDOR_PROPERTIES += \
    ...
    persist.log.tag.AudioALSACaptureDataClient=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataClientAurisysNormal=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataClientDsp=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataClientSyncIO=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderAAudio=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderBase=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderBLE=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderBTCVSD=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderBTSCO=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderDL=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderDsp=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderDspRaw=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderEchoRef=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderEchoRefBase=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderEchoRefBTCVSD=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderEchoRefBTSCO=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderEchoRefExt=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderEchoRefUsb=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderFMRadio=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderHAP=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderMix=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderModemDai=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderNormal=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderTDM=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderUL=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderUsb=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderVoice=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureDataProviderVOW=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureHandlerAAudio=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureHandlerAEC=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureHandlerBase=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureHandlerBT=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureHandlerDsp=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureHandlerFMRadio=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureHandlerModemDai=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureHandlerNormal=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureHandlerSyncIO=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureHandlerTDM=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureHandlerUsb=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureHandlerVoice=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACaptureHandlerVOW=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSACodecDeviceBase=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSADataProcessor=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSADeviceConfigManager=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSADeviceParser=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSADriverUtility=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAFMController=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAHardware=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAHardwareResourceManager=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSALoopbackController=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSANLEController=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAParamTuner=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPcmDataCaptureIn=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerAAudio=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerBase=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerBTCVSD=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerBTSCO=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerDsp=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerFast=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerFmAdsp=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerFMTransmitter=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerHDMI=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerI2SHDMI=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerMixer=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerNormal=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerOffload=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerTVOut=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerUsb=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAPlaybackHandlerVoice=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSASampleRateController=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAStreamIn=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAStreamManager=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAStreamOut=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAStreamOutCustom=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioALSAVoiceWakeUpController=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioMessengerIPI=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioMTKGainController=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioSmartPaController=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.AudioSpeechEnhanceInfo=$(VENDOR_LOG_LEVEL)
